...
import br.com.dio.service.GameTimerService;
...
public class MainScreen {
    ...
    public MainScreen(final Map<String, String> gameConfig) {
        ...
        this.gameTimerService = new GameTimerService(); // Construtor de GameTimer marca o início do jogo
    }
    ...
    private void addFinishGameButton(final JPanel mainPanel) {
        finishGameButton = new FinishGameButton(e -> {
            if (boardService.gameIsFinished()){
                showMessageDialog(null, "Parabéns você concluiu o jogo\n Tempo Decorrido: " + gameTimerService.getFormattedTimeElapsed());
