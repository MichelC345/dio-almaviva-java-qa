...
public class FornecedorServiceImpl implements FornecedorService {
	...
	public String consultarSituacaoFiscal(Long id) {
		String cnpj = this.buscarPorId(id).getCNPJ();
		CnpjResponse response = brasilAPIService.consultarCnpj(cnpj);

    	return response.getDescricaoSituacaoCadastral();
	}
}
